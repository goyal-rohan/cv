...
\item Were able to find a near linear time algorithm for list decoding multiplicity codes (ongoing work, with Prof. Mrinal Kumar and Ashutosh Shankar, resulted in a paper)
\end{list2}
